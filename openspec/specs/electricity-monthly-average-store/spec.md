# Spec: electricity-monthly-average-store

## Purpose

Defines the rolling calendar-month daily average buffer maintained by `NordpoolBeStore`: how it is populated, persisted, trimmed, and exposed as the `monthly_average` property.
