...
name: wiki
description: >-
  Use when building or maintaining a personal LLM-powered knowledge base.
  Triggers: ingesting sources into a wiki, querying wiki knowledge, linting
  wiki quality, 'add to wiki', 'what do I know about', or any mention of
  'LLM wiki' or 'Karpathy wiki'.
argument-hint: "Describe what you want to ingest, query, or lint"
metadata:
  version: "1.0.0"
---
